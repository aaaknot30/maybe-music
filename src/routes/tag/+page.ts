...
//  /2.0/?method=tag.gettopalbums&tag=disco&api_key=YOUR_API_KEY&format=json
	...
	const response = await fetch(`https://ws.audioscrobbler.com/2.0/?method=tag.getInfo&tag=pop&track=believe&api_key=c427f710e83c3ba7be53cdf86dac1e0f&format=json`, {
    method: "GET",
    headers: {
